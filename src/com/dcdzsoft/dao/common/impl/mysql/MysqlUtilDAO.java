package com.dcdzsoft.dao.common.impl.mysql;
 ...
 * @version 1.0
 */
public class MysqlUtilDAO implements UtilDAO {
    private static final Log log = LogFactory.getLog(MysqlUtilDAO.class.
            getName());
    ...
    public java.sql.Date getCurrentDate() throws EduException {
        ...
        if(jetLag != 0.0){
            sql = "SELECT DATE_FORMAT(DATE_ADD(NOW(), INTERVAL "+jetLag+" HOUR ),'%Y-%m-%d')";
        }
    ...
    public java.sql.Time getCurrentTime() throws EduException {
        ...
        if(jetLag != 0.0){
            sql = "DATE_FORMAT(DATE_ADD(NOW(), INTERVAL "+jetLag+" HOUR ),'%H:%i:%s')";
        }
    ...
    public java.sql.Timestamp getCurrentDateTime() throws EduException {
        ...
        if(jetLag != 0){
            sql = "SELECT DATE_ADD(NOW(), INTERVAL "+jetLag+" HOUR )";
        }
    ...
    public String constructNMSql(String querySQL, List orderByField,
        ...
        recordBegin = recordBegin - 1;
        String orderBy = " ORDER BY " + sbField.toString();

        sql = querySQL + orderBy + " LIMIT " + recordBegin + "," + recordNum;
    ...
    public String nvlNumSQL(String columnName, String repaceValue) {
        return " IFNULL(" + columnName + "," + repaceValue + ") ";
    }
